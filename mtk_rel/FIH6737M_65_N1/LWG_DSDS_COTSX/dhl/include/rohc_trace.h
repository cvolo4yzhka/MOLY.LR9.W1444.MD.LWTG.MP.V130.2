...
#include "L1Trc.h"
	...
	#define ROHC_LOG_PTRN_UDP_CHECKSUM(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x4516 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_OPT_RESET(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x4D16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_OPT_UPDT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4E16 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_ACK_STRIDE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5016 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_PAD_BIT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5216 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_PT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5816 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_TS_OFF_TS_STRIDE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5A16 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_LIST_INSERT_ONLY(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6116 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_RCVD_FDBK2_OPT_INVALID(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6816 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_UNKNOWN_IP_VER(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6A16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_CNTXT_REPLACE(v1, v2, v3, v4) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x6C16 | ((short)(v1) << 16), (long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ROHC_LOG_PARAM_SIZE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x6D16 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_TCP_OPT_EOL_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x7216 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_TCP_OPT_SIZE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7316 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_TCP_OPT_END_ERR(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x7416 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_IPV4_FLAG_FRAG_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7516 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_C_LOG_REF_CSRC_LIST_UNDERRUN(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7916 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_FDBK_ACK_NUM(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8316 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_FDBK_PRODUCE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x8416 | ((unsigned short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_REF_LIST_REPLACED(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8516 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_FDBK_START(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x8716 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_RCVD_MODE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x8F16 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_PARSE_CID_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9016 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_MATCH_NO_CNTXT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x9216 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_NO_NEED(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9416 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_CANCEL(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x9516 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_BCID_MATCH(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9616 | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_FDBK_SUPRESS(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9916 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_STATE_TRAN(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xA016 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_IR_DEC_FAIL(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xA416 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_BCID_NO_MATCH(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xD316 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_REP_PROFILE_NOT_SUPPORT(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xD416 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_PROFILE_NOT_SUPPORT(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD916 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_UNKNOWN_CID(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xDB16 | ((short)(v1) << 16));\
	} while(0)
#else
