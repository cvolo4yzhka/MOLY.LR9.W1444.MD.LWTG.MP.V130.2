...
#define UL1D_TRC_HWTPC_CMD2_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) TRC_SEND_8_DATA(TRC_MERGE_2S(0x322E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)), TRC_MERGE_2S((short)(v8), (short)(v9)), TRC_MERGE_2S((short)(v10), (short)(v11)), TRC_MERGE_2S((short)(v12), (short)(v13)), TRC_MERGE_2S((short)(v14), (short)(v15)))
	...
	#define UL1D_TRC_EM_PWR_TX(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x332E, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)));\
	} while(0)
#else
	#define UL1D_TRC_EM_PWR_TX(v1, v2, v3, v4, v5)
#endif
#define UL1D_TRC_EM_PWR_TX_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x332E, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)))

#if defined(L1_CATCHER)
	#define UL1D_TRC_ACS_START() do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x342E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_ACS_START()
#endif
#define UL1D_TRC_ACS_START_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x342E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define UL1D_TRC_TIMING_ERROR_ACS(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x352E, (short)(v1)));\
	} while(0)
#else
	#define UL1D_TRC_TIMING_ERROR_ACS(v1)
#endif
#define UL1D_TRC_TIMING_ERROR_ACS_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x352E, (short)(v1)))

#if defined(L1_CATCHER)
	#define UL1D_TRC_32KLESS_TIMING_ERROR_VALID(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x362E, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UL1D_TRC_32KLESS_TIMING_ERROR_VALID(v1)
#endif
#define UL1D_TRC_32KLESS_TIMING_ERROR_VALID_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x362E, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define UL1D_TRC_32KLESS_TIMING_ERROR(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x372E, (short)(v1)));\
	} while(0)
#else
	#define UL1D_TRC_32KLESS_TIMING_ERROR(v1)
#endif
#define UL1D_TRC_32KLESS_TIMING_ERROR_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x372E, (short)(v1)))
...
#endif
#define UL1D_TRC_32KLESS_DIVIDER_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x382E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#endif
#define UL1D_TRC_32KLESS_FPM_DIVIDER_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x392E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER)
	#define UL1D_TRC_SM_FREQ_OFFSET(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x3A2E, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3));\
	} while(0)
#else
	#define UL1D_TRC_SM_FREQ_OFFSET(v1, v2, v3)
#endif
#define UL1D_TRC_SM_FREQ_OFFSET_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3A2E, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3))
