...
// 4G speech
   ...
   TRC_MSG(SPC_DEC_CHECK_3G_DL_BUFFER_INDEX  ,"[ENC] Check DL 3G DEC Buffer Index : index= %x,Count= %x,Read =%x,Write =%x")
   ...
   TRC_MSG(SPC_ENC_CHECK_DELEY_TIME          ,"[ENC] Check Deley time  , time(us)=%x")
