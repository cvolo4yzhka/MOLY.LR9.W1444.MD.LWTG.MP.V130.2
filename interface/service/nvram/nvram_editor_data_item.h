...
#define NVRAM_EF_IMS_PROFILE_LID_VERNO                      "024"
...
#define NVRAM_EF_SBP_MODEM_CONFIG_LID_VERNO "065"
#define NVRAM_EF_SBP_MODEM_DATA_CONFIG_LID_VERNO "002"
...
typedef struct{
  ...
  kal_uint8     transfer_conf_call_as_1to1;     // 0
...
typedef struct{
  ...
  kal_uint8     loc_info_query_timer;                 //0x14 20
  kal_uint8     loc_info_refresh_timer;               //0x0A 10
